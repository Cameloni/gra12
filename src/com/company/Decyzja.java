...
//
        ...
        if (game.death==0) {
            ...
            setKwestia("Oddział niezadowolonych z Twoich rządów rebeliantów wdziera się do pałacu i przegania Cię po ulicach miasta. Zostajesz znieważony i ukamieniowany.");
            setKwe1("...");
            setKwe2("...");
            lub();
        }
